...
<head runat="server">
	...
	<script type="text/javascript">
		...
		async function printZpl() {
			...
			alert('กรุณาเชื่อมต่อเครื่องพิมพ์ผ่าน BrowserPrint ก่อน');
		}
		...
		<div class="container">
			<div class="header">
				...
				<div class="nav-buttons">
					<a href="BluetoothPrint.aspx" class="btn-nav"><i class="fab fa-bluetooth-b"></i> Bluetooth</a>
					<a href="Default.aspx" class="btn-nav"><i class="fas fa-home"></i> Home</a>
				</div>
			</div>

			<div class="info-box">
				<strong>WiFi:</strong> สำหรับเครื่องพิมพ์เครือข่าย แนะนำให้ใช้ <b>BrowserPrint</b> หรือใช้ <b>System Print</b> หากต้องการพิมพ์ผ่าน Android Print Service
			</div>
