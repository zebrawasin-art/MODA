...
public partial class WifiPrint : System.Web.UI.Page
{
    ...
    private void UpdateLabelImage()
    {
        ...
        protected void PrintButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string logMessage = string.Format("[{0:yyyy-MM-dd HH:mm:ss}] - WiFi Label Printed. Density: {1}dpmm, Size: {2}x{3}", DateTime.Now, Density.SelectedValue, Width.Text, Height.Text);
